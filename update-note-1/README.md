...
[<mark style="color:blue;">Unifi Apps SDK v1.6.0</mark>](https://docs.unifi.me/update-note-1/sdk-version/v1.6.0) has been released (Added support for in-app purchases in LINE Mini Apps).

## 16 January 2026

[<mark style="color:blue;">Unifi Apps SDK v1.5.2</mark>](https://docs.dappportal.io/mini-dapp/mini-dapp-sdk/release-note/v1.5.2) has been released (Minor issue fixed related to the USDT payment flow)
