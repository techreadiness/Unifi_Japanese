...
1. [Submit Unifi Apps Application](https://tally.so/r/D4BNjp)
2. Please review and submit the Unifi Apps SDK Terms & Conditions as instructed.
3. Receive your `clientId` and `clientSecret` via the submitted email.
