...
[Join Us >](https://docs.unifi.me/join-us-1)
...
* Sample code by method: [https://unifiapps-demo.unifi.me](https://unifiapps-demo.unifi.me)
* Full integration sample code: [https://github.com/techreadiness/dapp-starter](https://github.com/techreadiness/dapp-starter)
...
Please follow the [guide documentation](https://docs.unifi.me/unifi-apps-sdk/wallet-provider/domain-verification-via-reown) to create a `projectId`, then submit it through the Tech Support channel for registration.
...
A. Please first check whether the parameters you provided match the [example request code](https://docs.unifi.me/unifi-apps-sdk/payment-provider#id-1.-triggering-createpayment-api-from-mini-dapp) in the documentation.\
...
For more details, please refer to the [guide documentation](https://docs.unifi.me/unifi-apps-sdk/payment-provider/policy/payment#id-2-supported-currencies-and-minimum-charge-limits).
